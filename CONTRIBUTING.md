...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/SolaceLabs/solace-custom-monitor-solgeneos/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/SolaceLabs/solace-custom-monitor-solgeneos/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
* Search [GitHub](https://github.com/SolaceLabs/solace-custom-monitor-solgeneos/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/SolaceLabs/solace-custom-monitor-solgeneos) and clone your fork
locally.

```sh
git clone https://github.com/<my-github-repo>/solace-custom-monitor-solgeneos
```
...
```sh
$ git remote add upstream https://github.com/SolaceLabs/solace-custom-monitor-solgeneos
```
...
In GitHub, send a pull request to `solace-custom-monitor-solgeneos:master`.
...
* Open a GitHub [enhancement request issue](https://github.com/SolaceLabs/solace-custom-monitor-solgeneos/issues/new) and describe the new functionality.
