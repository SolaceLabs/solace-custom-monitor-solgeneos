...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/solacese/solgeneos-custom-monitors/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/solacese/solgeneos-custom-monitors/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
* Search [GitHub](https://github.com/solacese/solgeneos-custom-monitors/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/solacese/solgeneos-custom-monitors) and clone your fork
locally.

```sh
git clone https://github.com/<my-github-repo>/solgeneos-custom-monitors
```
...
```sh
$ git remote add upstream https://github.com/solacese/solgeneos-custom-monitors
```
...
In GitHub, send a pull request to `solgeneos-custom-monitors:master`.
...
* Open a GitHub [enhancement request issue](https://github.com/solacese/solgeneos-custom-monitors/issues/new) and describe the new functionality.
